...
export const FingerprintIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M2 12h.01"/>
      <path d="M21.8 16.2a1 1 0 0 0-1.8-.2l-2.4 4A1 1 0 0 0 18 22h-2a1 1 0 0 0-1-1v-2a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v2a1 1 0 0 0-1 1H5a1 1 0 0 0-.4 1.8l2.4 4a1 1 0 0 0 1.8-.2l.2-1"/>
      <path d="M7 18.08c.13-.6.43-2.3.5-3.08"/>
      <path d="M4.71 14c.12-.6.43-2.3.5-3"/>
      <path d="M12 5.1a1 1 0 0 0-1 1v.8"/>
    </svg>
  );
